...
import { ISystemHeaderStyle } from './system-header-style'
...
export type RequestChannels = {
  ...
  'system-header-style-changed': (colors: ISystemHeaderStyle | null) => void
...
export type RequestResponseChannels = {
  ...
  'get-system-header-style': () => Promise<ISystemHeaderStyle | null>
